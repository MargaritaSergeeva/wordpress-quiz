...
require __DIR__ . '/includes/crm-admin.php';
...
add_action('init', static function () {
    ...
    register_block_type(__DIR__ . '/block', [
        'render_callback' => static fn($a) => render_quiz((int) ($a['quizId'] ?? 0)),
    ]);
    add_shortcode(
        'wordpress_quiz',
        static fn($a) => wp_interactivity_process_directives(render_quiz((int) ($a['id'] ?? 0))),
    );
});
